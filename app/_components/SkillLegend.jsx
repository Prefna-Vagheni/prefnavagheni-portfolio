  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
        ...
        <div className="flex items-center gap-2">
          <div className="w-8 h-2 bg-foreground/80 rounded-full" />
          <span className="text-foreground/70">Advanced (75-89%)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-8 h-2 bg-foreground/60 rounded-full" />
          <span className="text-foreground/70">Intermediate (60-74%)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-8 h-2 bg-foreground/40 rounded-full" />
